...
export const resourceItems: ResourceItem[] = [
  ...
  { slug: "dielines-templates", title: "Dielines & Templates", type: "request", summary: "Request a dieline or template after structure and production requirements are confirmed.", topics: ["Structure type", "Product dimensions", "Cut and fold requirements", "Artwork handoff"] },
...
export const finishOptions = ["Matte / gloss lamination", "Hot foil", "Emboss / deboss", "Spot UV", "Window patching", "Aqueous coating"];
...
export const finishOptionsZh = ["哑光/亮光覆膜", "烫金", "压凸/压凹", "局部 UV", "贴窗", "水性涂层"];

// The two application paths are artwork review and the canonical dieline request.
// The retired duplicate dieline card is intentionally absent from resourceItems.
export const resourceApplicationSlugs = ["artwork-guidelines", "dielines-templates"] as const;

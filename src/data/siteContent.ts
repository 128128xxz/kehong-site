...
export const resourceItems: ResourceItem[] = [
  ...
  { slug: "materials-guide", title: "Materials Guide", type: "guide", summary: "Compare paper, board and corrugated materials by structure, appearance and use.", topics: ["Paper and board selection", "Structure and application", "Surface compatibility", "Project scope for specification review"] },
  ...
  { slug: "food-packaging-material-selection", title: "Food Packaging Material Selection", type: "guide", summary: "Prepare the product, handling and specification questions needed to confirm a food packaging material match.", topics: ["Product contact and handling brief", "Structure and fit", "Barrier or grease requirement", "Available documentation"] },
  ...
  { slug: "finishes-guide", title: "Finishes Guide", type: "guide", summary: "Understand how available finishing options affect visual effect and artwork planning.", topics: ["Matte or gloss lamination", "Hot foil", "Emboss or deboss", "Spot UV and coating", "Window patching"] },
...
export const resourceZhCopy: Record<string, { title: string; summary: string; topics: string[] }> = {
  ...
  "materials-guide": { title: "材料指南", summary: "按结构、外观和用途比较纸张、纸板和瓦楞材料。", topics: ["纸张和纸板选择", "结构与应用", "表面限制", "可确认的规格"] },
  "cupstock-vs-pe-coated-paper": { title: "杯纸与 PE 淋膜纸指南", summary: "在杯纸项目报价前，明确原纸、加工形态和淋膜要求。", topics: ["杯纸与加工组件", "纸卷、平张与扇形片", "涂层要求", "克重与应用需求"] },
  "food-packaging-material-selection": { title: "食品包装材料选型指南", summary: "整理食品包装材料评审所需的产品、操作和规格信息。", topics: ["产品接触与使用需求", "结构与适配", "阻隔或防油需求", "可提供资料"] },
  "paper-bag-structure-guide": { title: "纸袋结构指南", summary: "通过简明结构清单确认纸袋尺寸、提手、承重和零售展示需求。", topics: ["纸袋尺寸", "提手类型", "纸张与纸板选择", "印刷与包装"] },
  "corrugated-mailer-structure-guide": { title: "瓦楞邮寄盒结构指南", summary: "评审电商邮寄盒的纸板结构、闭合、保护点和内托需求。", topics: ["产品尺寸", "纸板与保护要求", "闭合与内托", "发货流程"] },

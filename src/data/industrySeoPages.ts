...
export const industrySeoPages = {
  ...
  customPaperProducts: {
    ...
    zhFaq: [
      { question: "可以根据样品或图纸确认产品吗？", answer: "请提供样品、图纸或目标规格，团队会确认合适的材料和生产路径。" },
  ...
  retailLifestyle: {
    ...
    zhEyebrow: "零售与生活方式包装",
    buyerFocus: ["Product footprint and presentation", "Board, paper and finish direction", "Branded print and component requirements", "Packing and dispatch needs"],
    zhBuyerFocus: ["产品尺寸与展示", "纸板、纸张与表面方向", "品牌印刷与部件需求", "包装与发货需求"],
    ...
    faq: [
      { question: "Can the packaging be developed around a retail product?", answer: "Yes. Share the product dimensions, presentation goal, quantity and artwork status so the structure and material direction can be reviewed." },
    ...
    zhFaq: [
      { question: "能按零售产品开发包装吗？", answer: "可以。请提供产品尺寸、展示目标、数量和设计稿状态，以评审结构和材料方向。" },
  ...
  ecommerceIndustrialProfessional: {
    ...
    title: "E-commerce & Professional Packaging for Dispatch and Protection",
    zhTitle: "电商与专业供应链纸包装",
    ...
    eyebrow: "E-commerce & Professional Packaging",
    zhEyebrow: "电商与专业供应链包装",
    ...
    faq: [
      { question: "Can you review a protective paper insert requirement?", answer: "Share the product dimensions, fragile points, packing process and expected quantity. The team can review a practical structure direction." },
    ...
    zhFaq: [
      { question: "可以评审保护性纸内托需求吗？", answer: "请提供产品尺寸、易损位置、包装流程和预期数量，团队会评审可行的结构方向。" },

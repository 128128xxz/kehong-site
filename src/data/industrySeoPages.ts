...
export const industrySeoPages = {
  ...
  paperPackagingSupplier: {
    ...
    zhDescription:
      "科宏支持食品包装盒、纸内托、纸垫片和彩印包装定制，服务海外采购和渠道客户。",
    ...
    zhFaq: [
      ...
      { question: "支持海外买家吗？", answer: "支持。网站面向出口询盘、多语言浏览、样品确认和出货包装。" },
    ],
  },
  customPaperProducts: {
    ...
    zhFaq: [
      { question: "可以根据样品或图纸确认产品吗？", answer: "请提供样品、图纸或目标规格，科宏确认合适的材料和加工方式。" },
      { question: "定制产品流程如何进行？", answer: "提交需求后，科宏确认规格。生产按批准细节执行，再安排检验和出货。" },
    ],
  },
  retailLifestyle: {
    ...
    zhDescription: "纸袋、展示盒、内托和品牌纸品部件，按零售陈列、礼赠和发货需求开发。",
    ...
    zhBuyerFocus: ["产品尺寸与展示", "纸板、纸张和表面要求", "品牌印刷和部件需求", "包装和发货需求"],
    ...
    zhCapabilities: ["纸袋、纸盒和内托开发", "结构和表面工艺评审", "生产前打样确认", "出口包装协调"],
    ...
    zhFaq: [
      ...
      { question: "除了纸盒，还能支持品牌纸品部件吗？", answer: "项目需求可同时包含纸袋、内托、纸卡和其他纸品部件。" },
    ],
  },
  ecommerceIndustrialProfessional: {
    ...
    zhBuyerFocus: ["产品保护与适配", "发货和搬运流程", "纸板结构和内托需求", "明确的数量和交期需求"],
    ...
    zhFaq: [
      { question: "可以评审保护性纸内托需求吗？", answer: "请提供产品尺寸、易损位置、包装流程和预期数量，科宏团队评审可行结构方案。" },
      { question: "如何开始电商包装报价？", answer: "请发送产品照片或图纸、尺寸、目标数量、目的地，以及邮寄盒、内托或印刷需求。" },
    ],
  },
} as const;

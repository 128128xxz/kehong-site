...
const copy = {
  ...
  en: {
    ...
    country: "Country",
    products: "Product or packaging need",
    ...
    file: "Upload a drawing or reference image",
    message: "Tell us what you need: size, material, quantity, print or delivery details.",
    privacy: `I agree that ${companyDisplayName.en} may process this inquiry according to the Privacy Policy.`,
    submit: "Request a quote",
    whatsapp: "WhatsApp",
    success: "Thank you. Your inquiry has been sent to our sales team. We’ll review the details and get back to you as soon as possible.",
    error: "We couldn’t send your inquiry. Please try again or contact us by email.",

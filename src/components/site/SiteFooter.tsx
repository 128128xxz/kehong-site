      ...
      <div className="kh-shell kh-footer-grid">
        ...
        <GlassSurface variant="contact-card" tone="dark" className="kh-footer-contact-column kh-glass-footer-card">
          ...
          <div className="kh-footer-contact">
            ...
            <a href={telHref(zh ? publicContact.factoryPhone : publicContact.internationalPhone)} aria-label={zh ? `拨打电话 ${publicContact.factoryPhone}` : `Call ${publicContact.internationalPhone}`}><Phone aria-hidden="true" /><span><strong className="kh-footer-contact-label">{copy.phoneLabel}</strong>{zh ? publicContact.factoryPhone : publicContact.internationalPhone}</span></a>

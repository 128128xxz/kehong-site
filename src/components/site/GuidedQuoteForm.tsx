...
const copy = {
  en: {
    eyebrow: "Request a quote", title: "Guided packaging quote", intro: "Tell us what you need, one step at a time. You can review each section before sending.",
    steps: ["Project", "Size & quantity", "Material & structure", "Printing & finish", "Delivery & contact"],
    next: "Continue", back: "Back", submit: "Request a quote", sending: "Sending…", success: "Thank you. Your inquiry has been sent to our sales team.", error: "We couldn’t send your inquiry. Please check the details and try again.", required: "Complete the required fields and accept the privacy policy.", whatsapp: "Continue on WhatsApp", progress: "Quote progress",
  ...
  zh: {
    eyebrow: "立即询价", title: "分步骤提交项目需求", intro: "按项目阶段填写信息，前后切换不会丢失当前内容。",
    steps: ["项目概况", "尺寸与数量", "材料与结构", "印刷与后处理", "交付与联系信息"],
    next: "下一步", back: "上一步", submit: "立即询价", sending: "提交中…", success: "询盘已接收，科宏团队会尽快跟进。", error: "提交失败，请检查必填项后重试。", required: "请完成必填项并同意隐私政策。", whatsapp: "微信咨询", progress: "询价进度",

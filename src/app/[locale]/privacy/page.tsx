  ...
  return (
    <div className="texture-paper min-h-screen text-(--kh-ink)">
      ...
      <main className="mx-auto max-w-4xl px-4 py-14 sm:px-6 lg:px-8">
        ...
        <h1 className="kh-editorial-heading mt-4 text-4xl text-(--kh-ink)">{isZh ? "隐私政策" : "Privacy Policy"}</h1>
        <div className="prose prose-stone mt-8 max-w-none">
          <p>{isZh ? "当您通过 Kehong 网站提交询盘时，我们会使用您主动提供的姓名、公司、联系方式、产品需求和附件，仅用于回复咨询、确认规格与报价。" : "When you submit an inquiry through the Kehong website, we use the name, company, contact details, product requirements and attachments you provide to respond, confirm specifications and prepare a quotation."}</p>

...
await logoPage.setContent(`<!doctype html><html><head><style>
  * { box-sizing: border-box; } body { margin: 0; padding: 48px; color: #171713; background: #f4f1e8; font-family: Arial, sans-serif; }
  ...
  <div class="card dark"><span class="label">Full lockup · deep green</span><img class="logo-full" src="${baseURL}/brand/kehong-logo-full-transparent.png" alt="Kehong Paper Products official logo" /></div>
  <div class="card white"><span class="label">Full lockup · white</span><img class="logo-full" src="${baseURL}/brand/kehong-logo-full-transparent.png" alt="Kehong Paper Products official logo" /></div>
  <div class="card cream"><span class="label">Mark · paper background</span><img class="mark" src="${baseURL}/brand/kehong-mark-transparent.png" alt="Kehong mark" /></div>
  <div class="card white"><span class="label">Header scale</span><div class="header"><img src="${baseURL}/brand/kehong-mark-transparent.png" alt="" /><div><strong>Kehong Paper Products</strong><span>Paper materials &amp; custom packaging</span></div></div></div>
  <div class="card dark"><span class="label">Footer scale</span><img class="logo-full" style="width:220px" src="${baseURL}/brand/kehong-logo-full-transparent.png" alt="Kehong Paper Products official logo" /></div>
  <div class="card white"><span class="label">Favicon derivatives</span><div class="sizes"><img src="${baseURL}/brand/kehong-mark-16.png" width="16" height="16" alt="16px Kehong mark" /><img src="${baseURL}/brand/kehong-mark-32.png" width="32" height="32" alt="32px Kehong mark" /><img src="${baseURL}/brand/kehong-mark-48.png" width="48" height="48" alt="48px Kehong mark" /><img src="${baseURL}/brand/kehong-mark-180.png" width="72" height="72" alt="Apple touch Kehong mark" /></div></div>
</div></body></html>`);
